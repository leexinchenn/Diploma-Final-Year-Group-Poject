...
<div style="clear:both"></div>	
	...
	{
		$uid = $_GET["id"];
		$result = mysqli_query($connect, "select * from feedback where User_ID = $uid");
	...
	<div class="table">
		<table border="1" id="myTable">
			<tr style="background-color:#D3D3D3;height:35px;font-size:18px;">
				...
				<th style="width:100px;">Feedback Type</th>
				<th style="width:200px;">Feedback Describe</th>
				<th style="width:200px;">Feedback Reply</th>
			</tr>	
			<?php
			...
			<tr>
				...
				<td class="nonebtn" style="word-wrap: break-word"> <?php echo $row["Feedback_Describe"]; ?> </td>
	...
	<?php 
		...
		?>
			<div id="none">
				<p><b>No feedback record yet.</b></p>
				<p><b>Click <a href="Feedback.php">here</a> to give us some feedback.</b></p>
			</div>
		<?php
		}
	}
