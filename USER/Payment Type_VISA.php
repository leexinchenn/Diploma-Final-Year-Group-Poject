...
<body>
	...
	<div class="bdy">
	<form name="payForm" action="DeliveryStatus.php?uid=<?php echo $uid; ?>&discount=<?php echo $discount; ?>&total=<?php echo $total; ?>&delivery=<?php echo $delivery; ?>&totPay=<?php echo $totPay; ?>&PayType=<?php echo "VISA"; ?>&PayStatus=<?php echo "Successful"; ?>" target="_blank" onsubmit="return validateForm()" method="post">
		<img src="http://localhost/fyp/icon/visanew.png" id="visa" />
		<br/><br/><br/>
